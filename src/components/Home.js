...
export default function Home(props) {
  ...
  <p className="display-8 text-center my-4">Keep fresh memories from your travels!</p>
  <p className="display-8 text-center my-4">Share them with friends or the community :)</p>
  </div>

  <div className={"col-md-9 bg-secondary p-4 " + displayCorners("right")}>
  <p className="display-8 text-center my-4">Sign in and start creating your diary</p>
